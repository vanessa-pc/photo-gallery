        ...
        if (userInfo.isNewUser && userInfo.providerId === "password") {
          try {
            ...
            await (projectAuth.currentUser &&
              deleteUser(projectAuth.currentUser));
            swal(
              `Error: ${error}; could not send email verification.`,
      ...
      <div className="front-singin">
        ...
        >
          <StyledFirebaseAuth
            ...
            uiConfig={configUI as any}
            firebaseAuth={projectAuth}
          />
        </motion.div>
      </div>
    </>
